...
# --- Configuration ---
GEMINI_API_KEY = "AIzaSyDA_YW4szomFbqfxUntf0xHQkljvqvUheE" 
...
# # --- Example Usage ---
# async def main():
#     # Before running, create an empty file named "knowledge_base.json" in the same directory,
#     # or add some known idioms to it like this:
#     # [
#     #     {
#     #         "figurative_speech": "a piece of cake",
#     #         "literal_meaning": "very easy"
#     #     }
#     # ]
#
#     translator = HybridTranslationSystem()
#
#     # --- Test Case 1: Literal text ---
#     # Expected: Should be routed to the local NLLB model.
#     literal_text = "The book is on the table."
#     result1 = await translator.process_text(literal_text, target_language="hi")
#     print("\n✅ Final Output (Literal):", result1)
#
#     # --- Test Case 2: Figurative text already in the database ---
#     # Expected: Should detect from DB and use Gemini for context-aware translation.
#     figurative_text_known = "Don't worry, this task is a piece of cake."
#     result2 = await translator.process_text(figurative_text_known, target_language="hi")
#     print("\n✅ Final Output (Known Figurative):", result2)
#
#     # --- Test Case 3: New figurative text NOT in the database ---
#     # Expected: Should call Gemini to detect, then call again to learn the meaning,
#     # save it to knowledge_base.json, and finally translate with context.
#     figurative_text_new = "He decided to bite the bullet and finish the difficult project."
#     result3 = await translator.process_text(figurative_text_new, target_language="hi")
#     print("\n✅ Final Output (New Figurative):", result3)
#
#
